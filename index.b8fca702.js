...
document.addEventListener("keydown", (e)=>{
    if (game.getStatus() !== (0, _constants.GAME_STATUS).PLAYING) return;
    if ([
        "ArrowLeft",
        "ArrowRight",
        "ArrowUp",
...
function updateMessages() {
    ...
    messageWin.classList.toggle("hidden", gameStatus !== (0, _constants.GAME_STATUS).WIN);
    messageLose.classList.toggle("hidden", gameStatus !== (0, _constants.GAME_STATUS).LOSE);
    messageStart.classList.toggle("hidden", gameStatus !== (0, _constants.GAME_STATUS).IDLE);
}
function updateGrid() {
...
},{"../modules/Game.class":"eIbh2","../constants":"gyTPV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eIbh2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Game {
    ...
    mergeLine(tiles) {
        ...
        let newScore = 0;
        for(let i = 0; i < merged.length - 1; i++)if (merged[i] === merged[i + 1]) {
            merged[i] *= 2;
            newScore += merged[i];
            merged.splice(i + 1, 1);
        }
    ...
    updateGameStatus() {
        if (this.hasWinningTile()) this.status = (0, _constants.GAME_STATUS).WIN;
        else if (!this.hasPossibleMoves()) this.status = (0, _constants.GAME_STATUS).LOSE;
    }
    hasWinningTile() {
    ...
    hasPossibleMoves() {
        ...
        for(let row = 0; row < this.gridSize; row++)for(let col = 0; col < this.gridSize; col++){
            ...
            const canMergeRight = col < this.gridSize - 1 && current === this.grid[row][col + 1];
            const canMergeDown = row < this.gridSize - 1 && current === this.grid[row + 1][col];
...
},{"../constants":"gyTPV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gyTPV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _constants = require("./constants");
parcelHelpers.exportAll(_constants, exports);

},{"./constants":"dCjhd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dCjhd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
